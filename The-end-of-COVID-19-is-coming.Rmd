...
```{r}
#Media reports weekly COVID-19 trend, so frequency of 7 is used for all countries. 
...
ggplot(data= US_2021, aes(date,new_cases)) + geom_line()
...
ggplot(data= China_2021, aes(date,new_cases)) + geom_line()
...
ggplot(data= India_2021, aes(date,new_cases)) + geom_line()
...
summary(forecast_India_2021)
accuracy(forecast_India_2021)
...
ggplot(data= UK_2021, aes(date,new_cases)) + geom_line()
...
ggplot(data= EU_2021, aes(date,new_cases)) + geom_line()
